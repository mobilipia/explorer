        ...
        <div class="row">
          <div class="col-sm-12">
            <ul class="list-unstyled">
              <li>Sources on <a href="https://github.com/mobilipia/ibchain-explorer" target="_blank">GitHub</a></li>
              <li><a href="https://inksnation.io/doc/" target="_blank">IBLedger docs</a></li>
            </ul>
          </div>
        </div>
      </div>
